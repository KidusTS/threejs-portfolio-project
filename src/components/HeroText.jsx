  ...
  return (
    <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
      ...
      <div className="flex-col hidden md:flex c-space">
        <motion.h1 className="text-4xl font-medium" variants={variants}  initial={"hidden"} animate={"visible"} transition={{delay:1}}>Hey Kidus Here</motion.h1>
      ...
      <div className="flex flex-col space-y-6 md:hidden">
        <motion.p className="text-4xl font-mediun" variants={variants}  initial={"hidden"} animate={"visible"} transition={{delay:1}}>Hey Kidus Here</motion.p>
        <div>
          ...
          <motion.p className="text-4xl font-black text-neutral-300" variants={variants}  initial={"hidden"} animate={"visible"} transition={{delay:1.8}}>Web Applictions</motion.p>
        </div>
      </div>
    </div>
  )
